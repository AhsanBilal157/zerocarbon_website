                    ...
                    <div className="row row-custom">
                        ...
                        <div className="col-lg-10 col-blog-detail-otr">
                            ...
                            <div className="col-blog-detail-inr" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="50">
                                 {Blogdata.map((data ,i)=>
                                    <div className="lower-about1" key={i} data-aos="fade-up" data-aos-duration="1000" data-aos-delay="50">

                                    <p className="heading3-head12">{data.heading}</p>
                                    <p className="heading3-p1">{data.detail}</p>
                                    </div>
                                 )}
                                <ul className="heading3-ul" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="50">
                                    ...
                                    <li className="heading3-li">
                                        ...
                                        Climate Change and Water Crises in Pakistan: Implications on Water Quality and Health Risks - PMC (nih.gov)
                                        </p>
                                    </li>
                                    <li className="heading3-li">
                                        <p className="heading3-p ">
                                        EPA Report Shows Disproportionate Impacts of Climate Change on Socially Vulnerable Populations in the United States | US EPA
                                        </p>
                                    </li>
                                    <li className="heading3-li">
                                        <p className="heading3-p ">
