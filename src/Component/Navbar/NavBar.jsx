      ...
      <div className="header-container">
        <div className="header-inr">
          ...
          <ul className="header-ul ">
            ...
            <li className="header-li">
              <Link className="header-a" to="/ServiceView" onClick={handleClick}>
              Services
              </Link>
            </li>
            <li className="header-li">
            ...
            <li className="header-li">
              <Link className="header-a" to="/Initiatives" onClick={handleClick}>
              initiative 
              </Link>
            </li>
            <li className="header-li">
      ...
      <Offcanvas.Body className="offcanvas-body-main">
        ...
        <div className="offcanvas-body">
          <ul className="offcanvas-ul">
            <li className="header-li">
              <Link className="header-a" to="/" onClick={handleClick}>Home</Link>
            </li>
            <li className="header-li">
              <Link className="header-a" to="/About" onClick={handleClick}>About us</Link>
            </li>
            <li className="header-li">
              <Link className="header-a" to="/ServiceView" onClick={handleClick}>Services</Link>
            </li>
            <li className="header-li">
              <Link className="header-a" to="/Faq" onClick={handleClick}>FAQ's</Link>
            </li>
            <li className="header-li">
              <Link className="header-a" to="/Initiatives" onClick={handleClick}>initiative</Link>
            </li>
            <li className="header-li">
              <Link className="header-a" to="/Blog" onClick={handleClick}>Blogs</Link>
            </li>
            <li className="header-li">
              <Link className="header-a" to="/News" onClick={handleClick}>News</Link>
            </li>
          </ul>
